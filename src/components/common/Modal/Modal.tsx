  ...
  return createPortal(
    <div>
      <div
        ...
        onClick={handleClose}
      />
      <div className="fixed left-1/2 top-1/2 z-50 flex w-3/4 max-w-[20rem] -translate-x-1/2 -translate-y-1/2 transform flex-col rounded-2xl bg-white p-6 font-OAGothic">
        <CloseIcon

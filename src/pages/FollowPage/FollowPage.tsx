...
const FollowPage = memo(() => {
  ...
  return (
    <div className="h-full bg-white">
      ...
      <div
        className={`
          relative mb-3 flex border-b-2 border-gray-200 duration-[400ms] after:absolute after:-bottom-1 after:h-[5px] after:w-full after:scale-x-[0.45] after:rounded-full after:bg-main-base after:transition-all after:duration-500 after:content-[""]
          ${
            showFollowers
